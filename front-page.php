  ...
  <section id="hp-hero" class="hero" style="background-image:url(<?php echo esc_url($hero_bg_img_and_css['image_url']); ?>); <?php echo esc_html($hero_bg_img_and_css['image_css']); ?>">
    <div class="container">
      <div class="hero-caption">
        <h1><?php echo esc_html(get_post_meta($page_id, 'hero_settings_caption', true)); ?></h1>
        <div class="inline-btns">
          <?php 
            ...
            if($button_one): ?>
              <a href="<?php echo esc_url($button_one['url']); ?>" class="btn-main"><?php echo esc_html($button_one['title']); ?></a>
          <?php endif; if($button_two): ?>
            <a href="<?php echo esc_url($button_two['url']); ?>" class="btn-main"><?php echo esc_html($button_two['title']); ?></a>
          <?php endif; ?>
        </div>
      </div>
    </div>
      ...
      <section id="hp-about" style="background-image:url(<?php echo esc_url($about_section_bg_img_and_css['image_url']); ?>); <?php echo esc_html($about_section_bg_img_and_css['image_css']); ?>">
        <div class="container">
          <div class="hp-about">
            ...
            <a href="<?php echo esc_url(home_url('about')); ?>" class="btn-main btn-alt">About Us</a>
          </div>
        </div>
      </section>
  <?php endif; ?>
  ...
  <?php
    ...
    if($guarantees || $guarantees_section_title): ?>
      <section id="hp-guarantees">
        <div class="container">
          <article>
            <h2><?php echo esc_html($guarantees_section_title); ?></h2>
            <?php echo wp_kses_post(get_post_meta($page_id, 'guarantees_section_settings_content', true)); ?>
          </article>
                ...
                <?php for($b = 0; $b < $guarantees; $b++): ?>
                  <div class="col-sm-3">
                    <div class="badge">
                      ...
                      ?>
                      <img src="<?php echo esc_url($guarantee_image[0]); ?>" class="img-responsive center-block" alt="" />
                      <h3><?php echo esc_html(get_post_meta($page_id, 'guarantees_section_settings_guarantees_' . $b . '_title', true)); ?></h3>
                    </div>
                  </div>
                <?php endfor; ?>
              </div>
    ...
    <div class="container">
      <div class="service-areas">
        ...
        <div class="service-areas-caption">
          ...
          <?php echo wp_kses_post(get_post_meta($page_id, 'service_areas_section_settings_content', true)); ?>
        </div>
      </div>
    </div>
    <div class="bg-overlay"></div>
